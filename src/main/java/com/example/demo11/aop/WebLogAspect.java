package com.example.demo11.aop;

import cn.hutool.core.util.StrUtil;
import cn.hutool.core.util.URLUtil;
import cn.hutool.json.JSONUtil;
import com.example.demo11.dao.WebLogDAO;
...
public class WebLogAspect {
    ...
    @Pointcut("execution(public * com.example.demo11.controller.*.*(..))")
    public void webLog() {
    }
    ...
    public Object doAround(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        String generatID = GeneratID.getGeneratID();
        String urlStr = request.getRequestURL().toString();
        webLog.setWebLogId(generatID);
        webLog.setBasePath(StrUtil.removeSuffix(urlStr, URLUtil.url(urlStr).getPath()));
        webLog.setIp(request.getRemoteUser());
        webLog.setMethod(request.getMethod());
        Object object = getParameter(method, joinPoint.getArgs());
        if(object != null) {
